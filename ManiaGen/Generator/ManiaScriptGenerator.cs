...
public partial class ManiaScriptGenerator
{
    ...
    public IVariable Property(IVariable root, string path)
    {
        var propertyStatement = new PropertyStatement(root.ToStatement(), path);
        Root.Statements.Add(propertyStatement);

        return new Variable<Void>(root.Name, null);
    }
    ...
    {
        /*var propertyStatement = new PropertyStatement(root.ToStatement(), path);
        _root.Statements.Add(propertyStatement);*/
